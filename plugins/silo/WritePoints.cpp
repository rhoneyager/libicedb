	...
	namespace plugins {
		namespace silo {
				...
				bool ColMajorOrder)
			{
				...
				// Annoyingly, this option is being ignored!!!!!
				//int CMO = (ColMajorOrder) ? DB_COLMAJOR : DB_ROWMAJOR;
				//if (CMO)
				//	DBAddOption(optlist, DBOPT_MAJORORDER, (void*)&CMO); // Eigen matrices are in column-major ordering!
