...
namespace icedb {
	namespace io {
		namespace ddscat {
			...
			class ICEDB_DL_IO_DDSCAT rotationsBase
			{
			public:
				rotationsBase();
			...
			class ICEDB_DL_IO_DDSCAT rotations : public rotationsBase
			{
			public:
				rotations();
				...
				static std::shared_ptr<rotations> create(
					double bMin, double bMax, size_t bN,
					double tMin, double tMax, size_t tN,
					double pMin, double pMax, size_t pN);
				static std::shared_ptr<rotations> create();
				static std::shared_ptr<rotations> create(const ddPar &src);
				virtual ~rotations();
				...
				**/
				void getRots(std::map<std::tuple<double, double, double>, size_t > &) const;
