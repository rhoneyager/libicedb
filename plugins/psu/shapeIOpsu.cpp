...
namespace icedb {
	namespace plugins {
		namespace psu {
			namespace Shapes {
				...
				//------------------------------------------------------------------------------------------//
				icedb::Shapes::NewShapeProperties readPSUfile(std::shared_ptr<icedb::plugins::psu::psu_handle> h, std::shared_ptr<icedb::registry::IO_options> opts)
				{
	...
	using namespace icedb::plugins::psu::Shapes;
