# This script a heavily-modified version of OpenMD's script (https://github.com/OpenMD).
...
# Possible targets: qhull::qhull, qhull::static, qhull::reentrant, qhull::cpp
# Possible programs: qconvex, qdelaunay, qhalf, qhull, qvoronoi, rbox.

find_program(QHULL_BINARY qhull 
	PATHS ${QHULL_ROOT}/bin
	PATHS "$ENV{PROGRAMFILES}/QHull/bin" "$ENV{PROGRAMW6432}/QHull/bin"
	)
...
# qhull.dll, qhull_p.dll, qhull_r.dll, 
# qhull.lib, qhull_p.lib, qhull_r.lib, qhullcpp.lib, qhullstatic.lib, qhullstatic_r.lib,
# libqhull/, libqhull_r/, libqhullcpp/.
