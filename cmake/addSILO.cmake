...
if (WIN32 AND NOT CYGWIN)
	...
	IF(SILO_INCLUDE_DIR AND SILO_LIBRARY)
		...
		set_target_properties(silo PROPERTIES IMPORTED_LOCATION_RELEASE "${SILO_LIBRARY}")
		set_property(TARGET silo APPEND PROPERTY IMPORTED_CONFIGURATIONS RELWITHDEBINFO)
		set_target_properties(silo PROPERTIES IMPORTED_LOCATION_RELWITHDEBINFO "${SILO_LIBRARY}")
