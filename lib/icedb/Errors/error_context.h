...
**/
	...
	extern ICEDB_DL ICEDB_error_context_create_impl_f ICEDB_error_context_create_impl;
#define ICEDB_error_context_create(x) ICEDB_error_context_create_impl(x, (__FILE__), (int)__LINE__,(ICEDB_FUNCSIG));
	...
	extern ICEDB_DL ICEDB_error_context_copy_f ICEDB_error_context_copy;
	...
	extern ICEDB_DL ICEDB_error_context_appendA_f ICEDB_error_context_appendA;
	extern ICEDB_DL ICEDB_error_context_append_strA_f ICEDB_error_context_append_strA;
	...
	extern ICEDB_DL ICEDB_error_context_add_stringA_f ICEDB_error_context_add_stringA;
	typedef void (*ICEDB_error_context_add_string2A_f)(struct ICEDB_error_context*,
		const char* var_name, const char* var_val);
	extern ICEDB_DL ICEDB_error_context_add_string2A_f ICEDB_error_context_add_string2A;
	...
	extern ICEDB_DL ICEDB_error_context_widen_f ICEDB_error_context_widen;
...
/// A convenience wrapper for all error functions
	...
	ICEDB_DL extern const struct ICEDB_error_context_container_ftable ICEDB_ct_error_context;
