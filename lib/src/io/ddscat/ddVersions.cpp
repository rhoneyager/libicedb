...
namespace
{
	...
	verMapType avgMap {
		{70, "DDSCAT 7.0 [08.09.03]" },
	{707, "DDSCAT 7.0.7 [09.12.11]" },
	{708, "DDSCAT 7.0.8 [10.02.04]" },
	{71, "DDSCAT 7.1 [10.02.07]" },
	{710, "DDSCAT 7.1.0 [10.03.03]" },
	{720, "DDSCAT 7.2.0 [12.02.16]" },
	{721, "DDSCAT 7.2.1 [12.05.14]" },
	{722, "DDSCAT 7.2.2 [12.06.05]" },
	{73, "DDSCAT 7.3 [13.04.04]-BETA" },
	{730, "DDSCAT 7.3.0 [13.05.03]" }
	};
}
		...
		namespace ddscat
		{
			namespace ddVersions
			{
				size_t getVerId(const std::string& s)
				{
					...
					size_t ret = 0;
					if (!v.size()) ICEDB_throw(error::error_types::xBadInput)
						.add<std::string>("Reason", "Bad version id")
						.add<std::string>("Version_ID", s);
				...
				std::string getVerAvgHeaderString(size_t id)
				{
					...
					else ICEDB_throw(error::error_types::xBadInput)
						.add<std::string>("Reason", "getVerAvgHeaderString id not found")
						.add<size_t>("id_number", id);
					return s;
				}
