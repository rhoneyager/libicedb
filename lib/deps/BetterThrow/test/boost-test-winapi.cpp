...
using namespace BT::win;
using BT::convertStr;

BOOST_AUTO_TEST_CASE(win_getCWD)
{
...
BOOST_AUTO_TEST_CASE(win_getEnvironment)
{
...
BOOST_AUTO_TEST_CASE(win_getCmdLine) {
...
BOOST_AUTO_TEST_CASE(win_getElevated) {
	bool res = false;
...
BOOST_AUTO_TEST_CASE(win_getModulePath) {
...
BOOST_AUTO_TEST_CASE(win_getLoadedModules) {
	BT::ModuleInfo_t<> mi;
...
BOOST_AUTO_TEST_CASE(win_getUserName) {
...
BOOST_AUTO_TEST_CASE(win_getComputerName) {
	::BT::native_path_string_t res;
...
BOOST_AUTO_TEST_CASE(win_getAppConfigDir) {
	::BT::native_path_string_t res;
...
BOOST_AUTO_TEST_CASE(win_getHomeDir) {
	::BT::native_path_string_t res;
...
BOOST_AUTO_TEST_CASE(win_getStartTime) {
	::BT::native_path_string_t res;
