...
DL_ICEDB const ICEDB_attr_close_f ICEDB_attr_close = attr_close;
...
DL_ICEDB const ICEDB_attr_write_f ICEDB_attr_write = attr_write;
...
DL_ICEDB const ICEDB_attr_copy_f ICEDB_attr_copy = attr_copy;
...
DL_ICEDB const ICEDB_attr_getName_f ICEDB_attr_getName = attr_getName;
*/
/*
...
DL_ICEDB const ICEDB_attr_getParent_f ICEDB_attr_getParent = attr_getParent;

ICEDB_DATA_TYPES attr_getType(const ICEDB_attr *attr) {
	if (!validate_attr_ptr(attr)) return ICEDB_DATA_TYPES::ICEDB_TYPE_NOTYPE;
	return attr->type;
}
DL_ICEDB const ICEDB_attr_getType_f ICEDB_attr_getType = attr_getType;
*/
...
DL_ICEDB const ICEDB_attr_resize_f ICEDB_attr_resize = attr_resize;
...
DL_ICEDB const ICEDB_attr_create_f ICEDB_attr_create = attr_create;
...
DL_ICEDB const ICEDB_attr_open_f ICEDB_attr_open = attr_open;

bool attr_remove(ICEDB_fs_hnd* parent, const char* name) {
	ICEDB_DEBUG_RAISE_EXCEPTION();
	return false;
}
DL_ICEDB const ICEDB_attr_remove_f ICEDB_attr_remove = attr_remove;
...
DL_ICEDB const ICEDB_attr_getNumAttrs_f ICEDB_attr_count = attr_count;
...
DL_ICEDB const ICEDB_attr_exists_f ICEDB_attr_exists = attr_exists;

bool attr_rename(ICEDB_fs_hnd* parent, const char* oldname, const char* newname) {
	ICEDB_DEBUG_RAISE_EXCEPTION();
	return false;
}
DL_ICEDB const ICEDB_attr_rename_f ICEDB_attr_rename = attr_rename;

bool attr_freeAttrList(ICEDB_attr ***p) {
	ICEDB_DEBUG_RAISE_EXCEPTION();
	return false;
}
DL_ICEDB const ICEDB_attr_freeAttrList_f ICEDB_attr_freeAttrList = attr_freeAttrList;

ICEDB_attr *** const attr_openAllAttrs(const ICEDB_fs_hnd* parent, size_t* numAttrs, ICEDB_attr *** list) {
	ICEDB_DEBUG_RAISE_EXCEPTION();
	return nullptr;
}
DL_ICEDB const ICEDB_attr_openAllAttrs_f ICEDB_attr_openAllAttrs = attr_openAllAttrs;
...
DL_ICEDB const ICEDB_attr_fs_write_backend_f ICEDB_attr_fs_write_backend = attr_fs_write_backend;
