...
ICEDB_SYMBOL_PRIVATE void ICEDB_error_context_append(struct ICEDB_error_context *c, size_t sz, const char * data)
{
...
ICEDB_SYMBOL_PRIVATE void ICEDB_error_context_add_string(struct ICEDB_error_context *c, size_t var_sz, const char * var_name, size_t val_sz, const char * var_val)
{
...
ICEDB_SYMBOL_PRIVATE void ICEDB_error_context_widen(struct ICEDB_error_context *c, size_t numNewSpaces)
{
