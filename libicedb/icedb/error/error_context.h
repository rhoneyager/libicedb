...
#define ICEDB_error_context_create(x) ICEDB_error_context_create_impl(x, __FILE__, (int)__LINE__,ICEDB_DEBUG_FSIG);
	...
	DL_ICEDB void ICEDB_error_context_append(struct ICEDB_error_context*, uint16_t sz, const char* data);
	DL_ICEDB void ICEDB_error_context_append_str(struct ICEDB_error_context*, const char* data);
	...
	DL_ICEDB void ICEDB_error_context_widen(struct ICEDB_error_context*, uint16_t numNewSpaces);
