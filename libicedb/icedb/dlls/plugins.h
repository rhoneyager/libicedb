...
ICEDB_DLL_INTERFACE_DECLARE_FUNCTION(icedb_plugin_base, Register, bool, ICEDB_register_interface_f, ICEDB_get_module_f, ICEDB_DLL_BASE_HANDLE*, ICEDB_DLL_BASE_HANDLE*)
