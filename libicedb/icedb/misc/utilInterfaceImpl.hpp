...
ICEDB_DLL_INTERFACE_IMPLEMENTATION_SYMBOL_FUNCTION(ICEDB_core_util, wcsncpy_s, "ICEDB_COMPAT_wcsncpy_s", size_t, char *, size_t, const char*, size_t);
ICEDB_DLL_INTERFACE_IMPLEMENTATION_SYMBOL_FUNCTION(ICEDB_core_util, strdup_s, "ICEDB_COMPAT_wcsdup_s", char*, const char *, size_t);
